...
<body>
    <nav class="Menu">
        <img class="Menu-Logo" src="./imgs/logopawfoliomenor.png">
        <li><a href=""> HOME </a></li>
        <li> | </li>
        ...
        <main>
            ...
            <div class="page_03">
                <img class ="page_03_img"src="./imgs/ramester.jpg">
            </div>
            ...
            <img class="page_03_logo" src="./imgs/logopawfoliomenor.png">
        </main>
        <footer>
            <div class="rodape">
                <img class="footer_logo" src="./imgs/logopawfoliomenor.png">
                <img class="local_map" src="./imgs/complexodoalemao.png">
            ...
            <div class="icons">
                ...
                <img id="instagram"src="./imgs/instagram.png"> </a>

                <a href="https://www.facebook.com/groups/1827907527528293">
                <img id="facebook" src="./imgs/facebook.png"></a>

                <a href="https://www.youtube.com/watch?v=LieGF7OBNA4">
                <img id="youtube" src="./imgs/youtube.png"></a>
            </div>
            </div>
        </footer>  
</body>
